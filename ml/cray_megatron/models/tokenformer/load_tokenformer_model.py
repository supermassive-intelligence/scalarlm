...
def materialize_model(model_info):
    ...
    total_time = time.time() - start_time
    logger.info(f"from_pretrained latency: {total_time:.2f}s ({total_time/60:.1f} minutes)")  # Add this
    ...
    total_time = time.time() - start_time
    logger.info(f"create_llama_tokenformer_model latency: {total_time:.2f}s ({total_time/60:.1f} minutes)")  # Add this
    ...
    total_time = time.time() - start_time
    logger.info(f"model dtype conversion latency: {total_time:.2f}s ({total_time/60:.1f} minutes)")  # Add this
